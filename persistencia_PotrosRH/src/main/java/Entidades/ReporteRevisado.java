...
public class ReporteRevisado {
     ...
     */
    public ReporteMalaConducta getReporteMalaConducta() {return reporteMalaConducta;}
    /**
     ...
     */
    public void setReporteMalaConducta(ReporteMalaConducta reporteMalaConducta) {this.reporteMalaConducta = reporteMalaConducta;}
    /**
     ...
     * @param tieneAntecedentesPrevios Nuevo valor si se cuentan con antecedentes previos del empleado o no.
     */
     ...
     * @param entrevistasRealizadas Nuevas entrevistas realizadas para el reporte.
     */
