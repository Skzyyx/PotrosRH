 ...
 * 
 */
public class ModificarExpediente extends javax.swing.JPanel {
    /**
     ...
     */
    public ModificarExpediente() {initComponents();}
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        if (resultado == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(ModificarExpediente.class.getName()).log(Level.SEVERE, null, ex);
