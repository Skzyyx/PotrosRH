...
public class ReporteMalaConductaBO implements IReporteMalaConductaBO {
    ...
    public boolean registrarReporteNuevo(ReporteMalaConductaDTO reporteNuevo) throws ObjetosNegocioException{
        try {
            return reportesDAO.registrarReporteNuevo(ReporteMalaConductaMapper.toEntityNuevo(reporteNuevo));
    ...
    public List<ReporteMalaConductaDTO> obtenerReporte(String rfcEmpleado, LocalDate fechaIncidente) throws ObjetosNegocioException{
        try {
            ...
            List<ReporteMalaConducta> reportesObtenidos = reportesDAO.obtenerReporte(rfcEmpleado, fechaIncidente);
    ...
    public boolean registrarReporteSancionado(ReporteRevisadoSancionadoDTO reporteSancionadoNuevo) throws ObjetosNegocioException {
        try {
            return reportesDAO.registrarReporteSancionado(ReporteRevisadoMapper.toEntityNuevoSancionado(reporteSancionadoNuevo));
    ...
    public boolean registrarReporteOmitido(ReporteRevisadoOmitidoDTO reporteOmitidoNuevo) throws ObjetosNegocioException {
        try {
            return reportesDAO.registrarReporteOmitido(ReporteRevisadoMapper.toEntityNuevoOmitido(reporteOmitidoNuevo));
        } catch (AccesoDatosException e) {throw new ObjetosNegocioException(e.getMessage(), e);}
    }
}